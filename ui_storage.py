...
class Ui_Storage(object):
    def setupUi(self, Storage):
        ...
        Storage.resize(622, 436)
        self.verticalLayout_8 = QVBoxLayout(Storage)
        ...
        self.dontMoveToDirCompareOld = QRadioButton(Storage)
        self.buttonGroup_3 = QButtonGroup(Storage)
        self.buttonGroup_3.setObjectName(u"buttonGroup_3")
        self.buttonGroup_3.addButton(self.dontMoveToDirCompareOld)
        self.dontMoveToDirCompareOld.setObjectName(u"dontMoveToDirCompareOld")
        self.dontMoveToDirCompareOld.setEnabled(False)
        self.dontMoveToDirCompareOld.setMinimumSize(QSize(354, 0))
        self.dontMoveToDirCompareOld.setMaximumSize(QSize(354, 16777215))
        self.dontMoveToDirCompareOld.setChecked(True)

        self.verticalLayout_3.addWidget(self.dontMoveToDirCompareOld)

        self.moveToDirCompareOld = QRadioButton(Storage)
        self.buttonGroup_3.addButton(self.moveToDirCompareOld)
        self.moveToDirCompareOld.setObjectName(u"moveToDirCompareOld")
        self.moveToDirCompareOld.setEnabled(False)
        self.moveToDirCompareOld.setMinimumSize(QSize(351, 0))
        self.moveToDirCompareOld.setMaximumSize(QSize(351, 16777215))

        self.verticalLayout_3.addWidget(self.moveToDirCompareOld)
        ...
        self.groupBox = QGroupBox(Storage)
        ...
        self.dontTouchLog = QRadioButton(self.groupBox)
    ...
    def retranslateUi(self, Storage):
        Storage.setWindowTitle(QCoreApplication.translate("Storage", u"\u0421\u043e\u0431\u0440\u0430\u0442\u044c \u0445\u0440\u0430\u043d\u0438\u043b\u0438\u0449\u0435", None))
        ...
        self.insertTwoWhitespace.setText(QCoreApplication.translate("Storage", u"\u041f\u0440\u043e\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u043d\u0435\u0434\u043e\u0441\u0442\u0430\u044e\u0449\u0438\u0435 \u0434\u0432\u0430 \u043f\u0440\u043e\u0431\u0435\u043b\u0430 \u0432 patch.pck \u0438 \u0443\u0431\u0440\u0430\u0442\u044c \u043b\u0438\u0448\u043d\u0438\u0435", None))
        ...
        self.dontMoveToDirCompareOld.setText(QCoreApplication.translate("Storage", u"\u041d\u0435 \u043f\u0435\u0440\u0435\u043c\u0435\u0449\u0430\u0442\u044c \u043f\u0440\u0435\u0434\u044b\u0434\u0443\u0449\u0438\u0435 \u0445\u0440\u0430\u043d\u0438\u043b\u0438\u0449\u0435(-\u0430) \u0432 \"compare_old\"", None))
        self.moveToDirCompareOld.setText(QCoreApplication.translate("Storage", u"\u041f\u0435\u0440\u0435\u043c\u0435\u0449\u0430\u0442\u044c \u043f\u0440\u0435\u0434\u044b\u0434\u0443\u0449\u0438\u0435 \u0445\u0440\u0430\u043d\u0438\u043b\u0438\u0449\u0435(-\u0430) \u0432 \"compare_old\"", None))
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Storage", u"\u0427\u0442\u043e \u0434\u0435\u043b\u0430\u0442\u044c \u0441 \u0444\u0430\u0439\u043b\u0430\u043c\u0438 *.log ?", None))
        self.dontTouchLog.setText(QCoreApplication.translate("Storage", u"\u041d\u0438\u0447\u0435\u0433\u043e \u043d\u0435 \u0434\u0435\u043b\u0430\u0442\u044c", None))
        self.moveLog.setText(QCoreApplication.translate("Storage", u"\u041f\u0435\u0440\u0435\u043d\u043e\u0441\u0438\u0442\u044c \u0432 \u043f\u0430\u043f\u043a\u0443 log", None))
        self.removeLog.setText(QCoreApplication.translate("Storage", u"\u0423\u0434\u0430\u043b\u044f\u0442\u044c", None))
        self.openDir.setText(QCoreApplication.translate("Storage", u"\u041e\u0442\u043a\u0440\u044b\u0442\u044c \u0434\u0438\u0440\u0435\u043a\u0442\u043e\u0440\u0438\u044e \u043f\u043e\u0441\u043b\u0435 \u0441\u0431\u043e\u0440\u043a\u0438 \u0445\u0440\u0430\u043d\u0438\u043b\u0438\u0449(-\u0430)", None))
